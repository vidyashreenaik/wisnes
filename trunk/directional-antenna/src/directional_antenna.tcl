...
Antenna/DirectionalAntenna/FlatTop set Beamwidth_ 60.0
Antenna/DirectionalAntenna/FlatTop set Boresight_ 0.0
Antenna/DirectionalAntenna/FlatTop set NullLocation_ 0.0
Antenna/DirectionalAntenna/FlatTop set NullWidth_ 0.0
Antenna/DirectionalAntenna/FlatTop set Gm_ 1.0
Antenna/DirectionalAntenna/FlatTop set Gs_ 0.0
...
Antenna/DirectionalAntenna/Pattern set Beamwidth_ 60.0
Antenna/DirectionalAntenna/Pattern set Boresight_ 0.0

# Returns the antenna
Node/MobileNode instproc getAntenna { param0} {
    $self instvar ant_
    return $ant_($param0)
}
