...
set opt(tracefname) "simple_omni_antenna.tr"
set opt(namfname)   "simple_omni_antenna.nam"
set opt(thrfname)   "simple_omni_antenna.thr"
set opt(perfname)   "simple_omni_antenna.per"
set opt(fttfname)   "simple_omni_antenna.ftt"
