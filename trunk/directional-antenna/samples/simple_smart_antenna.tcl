...
set opt(ant)        Antenna/SmartAntenna                ;# Antenna model
set opt(ifqlen)     50                                  ;# Max packet in ifq
set opt(rp)         AODV                                ;# Routing protocol

set opt(tracefname) "simple_smart_antenna.tr"
set opt(namfname)   "simple_smart_antenna.nam"
set opt(thrfname)   "simple_smart_antenna.thr"
set opt(perfname)   "simple_smart_antenna.per"
set opt(fttfname)   "simple_smart_antenna.ftt"
...
proc createMeshNode {n xPos yPos angle} {
    ...
    Antenna/SmartAntenna set Boresight_ $angle
