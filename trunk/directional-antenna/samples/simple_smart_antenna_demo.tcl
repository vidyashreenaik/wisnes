...
set opt(ant)        Antenna/DirectionalAntenna/FlatTop  ;# Antenna model
set opt(ifqlen)     50                                  ;# Max packet in ifq
set opt(rp)         AODV                                ;# Routing protocol

set opt(tracefname) "simple_smart_antenna_demo.tr"
set opt(namfname)   "simple_smart_antenna_demo.nam"
set opt(thrfname)   "simple_smart_antenna_demo.thr"
set opt(perfname)   "simple_smart_antenna_demo.per"
set opt(fttfname)   "simple_smart_antenna_demo.ftt"
...
proc createMeshNode {n xPos yPos angle} {
    global opt ns per \
           meshNodes meshMacs meshIfqs \
           meshPhys

    puts "Creating mesh node $n"
    Antenna/DirectionalAntenna/FlatTop set Boresight_ $angle
...
createMeshNode 2    200    50  0
createMeshNode 3    280    50   180
createMeshNode 0    0      0    90
createMeshNode 1    0      90   270
