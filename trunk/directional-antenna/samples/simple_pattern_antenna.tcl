...
set opt(ant)        Antenna/DirectionalAntenna/Pattern  ;# Antenna model
set opt(ifqlen)     50                                  ;# Max packet in ifq
set opt(rp)         AODV                                ;# Routing protocol

set opt(tracefname) "simple_pattern_antenna.tr"
set opt(namfname)   "simple_pattern_antenna.nam"
set opt(thrfname)   "simple_pattern_antenna.thr"
set opt(perfname)   "simple_pattern_antenna.per"
set opt(fttfname)   "simple_pattern_antenna.ftt"
...
proc createMeshNode {n xPos yPos angle} {
    ...
    Antenna/DirectionalAntenna/Pattern set Boresight_ $angle
