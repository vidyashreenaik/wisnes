...
set val(rp)             AODVRTT                    ;# routing protocol
set val(rtAgentFunction) create-aodvrtt-agent
set val(distance)       100                        ;# distance between nodes (m)
set val(stop)           450
set val(tracefile)      "wireless-sim-aodv-grid.tr"
